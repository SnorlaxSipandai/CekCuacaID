...
const NavbarSearch = ({ inputSearch, setAnim, isVisible }: searchProps) => {
  ...
  return (
    <div>
      ...
      <nav className="fixed top-0 w-full h-15 bg-white/10 backdrop-blur-xl flex items-center justify-between z-10 px-4 max-[480px]:fixed max-[480px]:h-12 max-[480px]:py-4">
